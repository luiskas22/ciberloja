    ...
    async handleLogin(event) {
        ...
        try {
            ...
            if (isNumeric) {
                ...
                // Asegurar que el empleado tenga rol_id = 2
                if (response.rol_id !== 2) {
                    console.warn("El empleado no tiene rol_id = 2, forzando valor");
                    response.rol_id = 2;
                }
                ...
                // Asegurar que el cliente tenga rol_id = 1 (o establecerlo si no viene)
                if (response.rol_id !== 1) {
                    console.warn("El cliente no tiene rol_id = 1, forzando valor");
                    response.rol_id = 1;
                }
            ...
            const welcomeMessage = isNumeric 
                ? "¡Login exitoso! Bienvenido empleado." 
                : "¡Login exitoso! Bienvenido cliente.";
            SesionView.renderLoginSuccess(welcomeMessage);
