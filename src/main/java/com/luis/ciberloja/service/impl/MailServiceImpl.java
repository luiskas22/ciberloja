...
public class MailServiceImpl implements MailService {
    ...
    public void sendPasswordResetEmail(String to, String token, Long clienteId) throws MailException {
        ...
        StringBuilder body = new StringBuilder().append("<html>").append("<head>").append("<meta charset=\"UTF-8\">")
                ...
                .append(".warning { color: #D9534F; font-weight: bold; }")
    ...
    public void sendPedidoRealizado(String to, ClienteDTO cliente, Pedido pedido) throws MailException {
        ...
        StringBuilder body = new StringBuilder().append("<html>").append("<head>").append("<style>")
                ...
                .append("</div>")
                .append("<div class=\"section\">").append("<h3>Estado atual</h3>").append("<p>").append("Pendente")
                .append("</p>").append("</div>")
    ...
    public void sendEstadoPedido(String to, ClienteDTO cliente, Pedido pedido) throws MailException {
        ...
        try {
            ...
            StringBuilder body = new StringBuilder().append("<html>").append("<head>")
                    ...
                    .append(".status { color: #0068C4; font-weight: bold; }")
                    .append("</style>").append("</head>").append("<body>")
                    .append("<div class=\"container\">").append("<div class=\"header\">")
                    .append("<h2>Atualização do estado do seu pedido</h2>")
                    .append("<p>Nº do pedido: ").append(pedido.getId()).append("</p>")
                    .append("</div>")
                    .append("<div class=\"section\">").append("<p>Olá ").append(cliente.getNombre()).append(",</p>")
                    .append("<p>Informamos que o estado do seu pedido foi atualizado em ").append(new Date()).append(".</p>")
                    .append("<p><span class=\"status\">Estado atual: ").append(estadoMensaje).append("</span></p>")
                    .append("</div>")
                    .append("<div class=\"section\">").append("<h3>Detalhes do pedido</h3>")
                    .append(obtenerDetallesProductos(pedido)).append("</div>")
                    .append("<div class=\"section\">").append("<h3>Endereço de entrega</h3>").append("<p>")
                    ...
                    .append("<p>Obrigado por confiar na Ciberloja!</p>")
                    .append("<p>A equipa da Ciberloja</p>")
                    .append("</div>").append("</body>").append("</html>");
