	...
	getCreateForm(lang = 'pt') {
      ...
      <div class="productos-container">
        <div class="product-form-container">
          <h2 class="product-form-title" data-i18n="productos.create.title">${t.title}</h2>
          <form id="createProductoForm">
            <div class="form-section">
              <h3 class="form-section-title" data-i18n="productos.create.basicInfo">${t.basicInfo}</h3>
              <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" id="createDescripcion" name="createDescripcion" class="form-control" placeholder="${t.descriptionPlaceholder}">
                </div>
              </div>
            </div>
            <div class="form-section">
              <h3 class="form-section-title" data-i18n="productos.create.priceInventory">${t.priceInventory}</h3>
              <div class="row g-3">
                <div class="col-md-6">
                  <label for="createPrecio" class="form-label" data-i18n="productos.create.price">${t.price}</label>
                  <div class="input-group">
                    <span class="input-group-text">€</span>
                    <input type="number" step="0.01" id="createPrecio" name="createPrecio" class="form-control" placeholder="${t.pricePlaceholder}" required>
                  </div>
                </div>
                <div class="col-md-6">
                  <label for="createStockDisponible" class="form-label" data-i18n="productos.create.stock">${t.stock}</label>
                  <input type="number" id="createStockDisponible" name="createStockDisponible" class="form-control" placeholder="${t.stockPlaceholder}" required>
                </div>
              </div>
            </div>
            <div class="form-section">
              <h3 class="form-section-title" data-i18n="productos.create.classification">${t.classification}</h3>
              <div class="row g-3">
                <div class="col-md-4">
            ...
            <div class="form-section">
              <h3 class="form-section-title" data-i18n="productos.create.images">${t.images}</h3>
              <div class="mb-3">
            ...
            <div class="text-center mt-4">
              <button type="submit" class="btn btn-success px-4 py-2" data-i18n="productos.create.saveBtn">
                <i class="bi bi-check-circle me-2"></i>${t.saveBtn}
              </button>
            </div>
          </form>
